...
public class THttpClient extends TTransport {
  ...
  private void flushUsingHttpClient() throws TTransportException {
    ...
    try {      
      ...
      post.setHeader("Content-Type", "application/x-org.apache.thrift");
      post.setHeader("Accept", "application/x-org.apache.thrift");
      ...
      // org.apache.thrift struct is being read up the chain).
  ...
  public void flush() throws TTransportException {
    ...
    try {
      ...
      connection.setRequestProperty("Content-Type", "application/x-org.apache.thrift");
      connection.setRequestProperty("Accept", "application/x-org.apache.thrift");
